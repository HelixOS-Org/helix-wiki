export default function FeatureCard({ title, description, icon }: { title: string, description: string, icon: React.ReactNode }) {
  return (
    <div className="group relative p-8 rounded-2xl bg-zinc-900/50 border border-zinc-800 hover:border-helix-purple/50 transition-all duration-300 hover:bg-zinc-900/80">
